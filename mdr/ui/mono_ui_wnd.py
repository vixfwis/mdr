...
class Ui_mainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.btnStart, 7, 1, 1, 3)
        ...
        self.menu_2.addAction(self.menuConnect)
